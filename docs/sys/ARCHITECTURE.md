...
│   ├── updater.py                # UpdateChecker — GitHub releases API, version compare
...
| Auto update check | `updater.py` hits the public GitHub releases API on startup; silent offline (5s timeout, non-blocking), notifies only when newer |
